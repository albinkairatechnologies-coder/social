  ...
  const handleSubmitReply = async (commentId: string) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const updatedRes = await fetch(`/api/dashboard?clientId=${clientId}`);
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-slate-900/40 rounded-3xl border border-slate-250 dark:border-slate-800/80 p-8 shadow-sm">
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">Manage this client's connected pages, prompt AI contents, and automate publishing.</p>
          </div>
